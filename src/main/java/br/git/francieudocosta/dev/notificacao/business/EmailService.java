package br.git.francieudocosta.dev.notificacao.business;

import br.git.francieudocosta.dev.notificacao.business.dto.TarefasDTO;
import br.git.francieudocosta.dev.notificacao.infrastructure.exceptions.EmailException;
...
public class EmailService {
    ...
    public void enviaEmail(TarefasDTO dto){
        ...
        try{
            ...
            throw new EmailException("Erro ao enviar o email: " + e.getMessage(), e.getCause());
        }
    }
}
